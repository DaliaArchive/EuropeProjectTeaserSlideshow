$(function() {
  ...
  * */
  ...
  function sendGAEventVoteClick(){
    console.log("[DEBUG] event 'call_to_action click'");
    ga('send', 'event', 'call_to_action', 'clicked', 'user', 1);
  }
  ...
  * */
  ...
  // Activate goal events on call_to_action_triggers
  $(".call_to_action_trigger").on("click", sendGAEventVoteClick);
